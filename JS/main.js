...
function  menu(valor){
    if(valor == "disfraz"){
        $("#disfraz-form").removeClass("d-none");
        $("#usuario-form").addClass("d-none");
        $("#message-form").addClass("d-none");
    }
    else if(valor == "user"){
        $("#disfraz-form").addClass("d-none");
...
/* -------------------------------------------------- END MENU PARA DISFRAZ------------------------------- */

/* ----------------- --------------------------------------- DISFRAZ-------------------------------------- */
/* ----------------- Consultar ID Elementos para DISFRAZ--------------- */
function consultarDisfrazid(idElemento) {
    var id = idElemento;
    $.ajax(
        {
            url: 'https://g21df42d0cfb53f-db202110061827.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/costume/costume/' + id,
            type: 'GET',
            dataType: 'json',
...
/* --------------END Consultar ID Elementos para DISFRAZ--------------- */
/* --------------------- Listar Elementos para DISFRAZ----------------- */
function listarElementos(items){
    ...
    for(i=0;i<items.length;i++){
        ...
        myTable+="<td><button data-toggle='modal' data-target='#modaldisfraz' class='btn btn-outline-success' onclick='consultarDisfrazid("+items[i].id+")'> Detalle</button></td>";
...
/* ------------ End Listar Elementos para DISFRAZ---------------------- */
/* -------------- Agregar Elementos para DISFRAZ----------------------- */
...
/* ------------------- END Agregar Elementos para DISFRAZ-------------- */
/* --------------------- Consultar Elementos para DISFRAZ-------------- */
function consultar() {
    $.ajax(
             {
                url          : 'https://g21df42d0cfb53f-db202110061827.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/costume/costume',
...
/* ----------END Consultar Elementos para DISFRAZ---------------------- */

/* --------------- Actualizar Elementos para DISFRAZ------------------- */
function actualizar() {
...
/* --------------- END Actualizar Elementos para DISFRAZ---------------- */

/* -------------- Borrar Elementos para DISFRAZ------------------------- */
...
/* ----------END Borrar Elementos para DISFRAZ------------------ */
/*  ---------------------------------------------------------------END  DISFRAZ --------------------------------------------------- */
...
function consultarUsuarioId(idElemento) {
    ...
    $.ajax(
        {
            url: 'https://g21df42d0cfb53f-db202110061827.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + id,
            type: 'GET',
            dataType: 'json',
            success: function (json) {
                for (i = 0; i < json.items.length; i++) {
...
function consultarMensajeId(idElemento) {
    ...
    $.ajax(
        {
            url: 'https://g21df42d0cfb53f-db202110061827.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message/' + id,
            type: 'GET',
            dataType: 'json',
            success: function (json) {
                for (i = 0; i < json.items.length; i++) {
    ...
    $.ajax (
        {
            ...
            url          : 'https://g21df42d0cfb53f-db202110061827.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message',
            type         : 'POST',
            data         :  myData,
            dataType     : 'json',
